var act_id = 39, debug = true, token, openid;
var v_main, audio_index = null, audio_game = null, interval = null;
var weixinData = {
  loginUrl: 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb61fdb0e387cbcc4&redirect_uri=http%3a%2f%2fwww.22dm.com%2fact%2fh5%2fjump_2%2findex.html&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect',
  shareLink: 'http://www.22dm.com/act/h5/jump_2/index.html',
  shareTitle: '狼族训练营-万圣节版',
  shareDesc: '测测你是狼还是狗~',
  shareImg: 'http://www.22dm.com/act/h5/jump_2/res/Public/icon.jpg'
};
var userInfo = {
  openid: "test_39",
  name: "test",
...
var winSize = {
  ...
  ranking: {
    getRankingList: function () {
      ...
      let result = {
        ...
        "scoreList": [
          {
            "user": "oTaiPuPyqILdhRWZGt7Oszg9ue1I",
            "count": "0",
            "json": {
              "addtime": "2018-11-10",
              "score": "412",
              "name": "这就是大魔法！",
              "img": "http://thirdwx.qlogo.cn/mmopen/vi_32/t7m9IicvJgNwEDaJLqxo5xERQdY8hOFjzKekib5icc2Nzn9MuIGHtKdp0dxuqdt2yGRsheWWj0KpAIddw8ibU0DNiag/132",
              "sex": "0",
              "country": "GuangZhou",
              "province": ""
            }
          ...
          },
          {
            ...
            "json": {
              ...
              "score": "212",
              "name": "一紙繁花葬絆城",
              "img": "http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLjuSjpjA61fgoicicT0kt1XRNXWcalnOnjBicr1npbfyncQVhibrONJgibbUSloaDnUeqp0lUqVDKo0ibQ/132",
              "sex": "2",
              "country": "GuangZhou",
              "province": "北京"
            }
          ...
          {
            "user": "oTaiPuCVGEiaBij_44v8yxlmU2yc",
            "count": "0",
            "json": {
              "addtime": "2018-12-12",
              "score": "114",
              "name": "卢梦轲",
              "img": "http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJZzrPyyR1DuubMwOGSPj6qdo4uhkBBH6TGNp3J65qtE7icHrjicUGOxicGaibBOuUb6WiaNtA6rEibibleQ/132",
              "sex": "1",
              "country": "GuangZhou",
              "province": "河南"
            }
          ...
          {
            "user": "oTaiPuHWyD18k-xHkGndoicRdGr0",
            "count": "0",
            "json": {
              "addtime": "2018-11-28",
              "score": "102",
              "name": "海阔天空",
              "img": "http://thirdwx.qlogo.cn/mmopen/vi_32/x0DfPBlM4c6icnmRd2VDkuktx0KJO43thVS0aGf5llrCicOnTdicxRcSf69uicrXsOuce4Q2vyDGubia8YgvEMaWsvQ/132",
              "sex": "0",
              "country": "GuangZhou",
              "province": ""
            }
          ...
          {
            "user": "oTaiPuLmbzi0X59Gx4uyZmaak6SI",
            "count": "0",
            "json": {
              "addtime": "2018-12-16",
              "score": "98",
              "name": "徐郁斐",
              "img": "http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLWQ2hoM6VgBaUIiabNXNmOC2iczDJPtAVx5pte4KFJ9CWhe32RIP5xKbT530at1eEfmgQel3coSKCg/132",
              "sex": "2",
              "country": "GuangZhou",
              "province": "北京"
            }
          ...
          {
            "user": "oTaiPuEq2gTHPmO-QuSbxF0eNjdQ",
            "count": "0",
            "json": {
              "addtime": "2018-11-01",
              "score": "82",
              "name": "汶汶BeBe",
              "img": "http://thirdwx.qlogo.cn/mmopen/vi_32/HpxsSfXFSLnNGEribtpQic9pomUgaf9GLznbeKpk83jxibxqciaw6BLcV6WSqdiaX9jRUfo0mpj2gKn5cZibuiahEGACw/132",
              "sex": "0",
              "country": "GuangZhou",
              "province": ""
            }
    ...
    getPrize: function () {
      ...
      if (now > Date.parse("2018/12/31 00:00:00")) {
        var hasPrize = false;
        ...
        alert('排行榜截止于2018-12-31,请于结束后再来领取奖品!');
        return false;
      }
    }
  },
  ...
  resize: function () {
    ...
    if (winSize.topOffset < 0)
      $(".dialogs_close").css({ top: -winSize.topOffset + 20 });
    if (height < 1137) {
      $("#all").css({
        overflow: "hidden"
      });
...
var dialogs = {
  ...
  loadResFinish: function () {
    ...
    //cc.director.runScene(new GameResultScene({theme:0}));
  }
};
function vueInit() {
  v_main = new Vue({
    ...
    watch: {
      ...
      Game_timer: function (newValue, oldValue) {
