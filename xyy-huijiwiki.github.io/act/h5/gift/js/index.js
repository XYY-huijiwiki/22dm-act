var isPC = true, token, openid, nickname, headimgurl, sex, country, province, act_id = 23, debug = true;
var weixinData = {
	state: null,
...
var prize = {
	...
	begin: function () {
		...
		// 	}
		// });
		// $("#prize_tips").empty().text('对不起,你还没有完成本次任务。');
		$("#prize_tips").empty().text("你本次抽奖没有中奖,谢谢参与!");
		// userInfo.prize = 8
		// prize.dialogs(8)
	},
...
function htl(num) {
	shareList = [
		{ face: 'images/user/羊年喜羊羊_头像_喜羊羊.jpg', name: '喜羊羊', addtime: '2017年8月24日' },
		{ face: 'images/user/羊年喜羊羊_头像_美羊羊.jpg', name: '美羊羊', addtime: '2017年8月24日' },
		{ face: 'images/user/羊年喜羊羊_头像_懒羊羊.jpg', name: '懒羊羊', addtime: '2017年8月24日' },
		{ face: 'images/user/羊年喜羊羊_头像_沸羊羊.jpg', name: '沸羊羊', addtime: '2017年8月24日' },
		{ face: 'images/user/羊年喜羊羊_头像_暖羊羊.jpg', name: '暖羊羊', addtime: '2017年8月24日' },
		{ face: 'images/user/羊年喜羊羊_头像_慢羊羊.jpg', name: '慢羊羊', addtime: '2017年8月24日' },
	]
	shareList.length = num;
	init();
}