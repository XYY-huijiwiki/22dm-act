...
var weixinData = {
  shareTitle: '探险父子兵',
  shareDesc: '出发啦！叫上TA一起在浩瀚的宇宙里探险吧！',
  shareLink: 'https://act.22dm.com/act/h5/rush/index.html',
  shareImg: 'https://act.22dm.com/act/h5/rush/res/icon.jpg',
  loginUrl: 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb61fdb0e387cbcc4&redirect_uri=http%3a%2f%2fact.22dm.com%2fact%2fh5%2frush%2findex.html&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect',
...
var winSize = {
  ...
  ranking: {
    ...
    getPrize: function () {
      ...
      if (now < Date.parse("2020/08/31 00:00:00")) {
        var hasPrize = false;
...
function vueInit() {
  v_main = new Vue({
    ...
    data: {
      ...
      shop: { "type": "navigation", "img": "/img/index/dialogs/0618.jpg", "url": "/pages/shop/emoji/emoji?emoji_url=https://mp.weixin.qq.com/s/pIf1pO1pt0kKCOygLnuhhg" }
    },
    watch: {
      ...
      Game_score: function (newValue, oldValue) {
        if (newValue % 450 == 0) {
          ...
          if (GameManager.bridgeMax > 6) {
            GameManager.bridgeMax -= 1;
          }
          if (GameManager.germRamdon < 0.8) {
            GameManager.germRamdon += 0.03;
          }
          if (GameManager.bridgeSpaceMax < 100) {
            GameManager.bridgeSpaceMax += 0.5;
          }
        }
      },
    ...
    methods: {
      Game_reset: function () {
        ...
        this.Game_ice = this.roleId == 1 ? 1 : 2;
        this.Game_strong = this.roleId == 1 ? 1 : 2;
